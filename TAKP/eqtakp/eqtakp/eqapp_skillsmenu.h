...
void EQAPP_SkillsMenu_CreateMenu()
{
    ...
    g_skillsMenuGUIMenuItemTaunt.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Taunt);
    ...
    g_skillsMenuGUIMenuItemKick.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Kick);
    ...
    g_skillsMenuGUIMenuItemBash.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Bash);
    ...
    g_skillsMenuGUIMenuItemSlam.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Slam);
    ...
    g_skillsMenuGUIMenuItemDisarm.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Disarm);
    ...
    g_skillsMenuGUIMenuItemBackstab.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Backstab);
    ...
    g_skillsMenuGUIMenuItemForage.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_Forage);
    ...
    g_skillsMenuGUIMenuItemSenseHeading.SetFunctionLeftClick(&EQAPP_UseSkills_Toggle_SenseHeading);
