...
#define EQ_ADDRESS_IS_USE_VIS_ACTOR_LIST_ENABLED 0x00602604 // uint8_t ; UseVisActorList, set to 0 to see mobs moving from far away
...
// virtual key codes for GetAsyncKeyState() function
