...
std::map<std::string, std::function<void()>> g_InterpretCmdList =
{
    ...
    {"//ExtendedTargetsHeightFilter",      &EQAPP_ExtendedTargets_HeightFilter_Toggle},
    ...
    {"//MapBaseLayer",                     &EQAPP_Map_Layer0_Toggle},
    {"//MapLayer0",                        &EQAPP_Map_Layer0_Toggle},
    {"//MapLayer1",                        &EQAPP_Map_Layer1_Toggle},
    {"//MapLayer2",                        &EQAPP_Map_Layer2_Toggle},
    {"//MapLayer3",                        &EQAPP_Map_Layer3_Toggle},
