...
#define APPLICATION_NAME "EQTAKP Inject DLL"

#define EQ_STRING_DLL_NAME "eqtakp.dll"

#define EQ_STRING_EXECUTABLE_NAME "eqgame.exe"
#define EQ_STRING_PROCESS_NAME    "eqgame.exe"

#define EQ_STRING_BUILD_DATE "Version 1.1.39 (DX8)  Last Build Date: Oct  8 2002 10:34:54"

#define EQ_BUILD_DATE_ADDRESS    0x007F95D0
#define EQ_BUILD_DATE_BYTES_SIZE 60
#define EQ_BUILD_DATE_BYTES      "\x56\x65\x72\x73\x69\x6F\x6E\x20\x31\x2E\x31\x2E\x33\x39\x20\x28\x44\x58\x38\x29\x20\x20\x4C\x61\x73\x74\x20\x42\x75\x69\x6C\x64\x20\x44\x61\x74\x65\x3A\x20\x4F\x63\x74\x20\x20\x38\x20\x32\x30\x30\x32\x20\x31\x30\x3A\x33\x34\x3A\x35\x34\x00"
...
{
    BYTE bytes[EQ_BUILD_DATE_BYTES_SIZE];
    ReadProcessMemory(process_handle, (void*)EQ_BUILD_DATE_ADDRESS, &bytes, sizeof(bytes), 0);

    if (memcmp(bytes, EQ_BUILD_DATE_BYTES, sizeof(bytes)) == 0)
    {
        return 1;
    }
