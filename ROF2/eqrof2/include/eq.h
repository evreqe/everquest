...
// base address for game is dynamic
// base address + address = actual address

DWORD EQ_POINTER_GAME_BASE_ADDRESS            = 0xA64BB8;  // eqgame.exe
DWORD EQ_POINTER_GRAPHICS_DLL_BASE_ADDRESS    = 0x11D4690; // EQGraphicsDX9.DLL

DWORD EQ_POINTER_EQGraphicsDLL = 0x11D46A4; // _DrawHandler

DWORD EQ_OFFSET_GRAPHICS_DLL_AVERAGE_FRAMES_PER_SECOND = 0x1B8198; // FLOAT

DWORD EQ_OFFSET_GRAPHICS_DLL_DrawLine    = 0x88840;
DWORD EQ_OFFSET_GRAPHICS_DLL_DrawQuad    = 0x88510;

DWORD EQ_ORDINAL_GRAPHICS_DLL_DrawLine    = 0x84;
DWORD EQ_ORDINAL_GRAPHICS_DLL_DrawQuad    = 0x9C;

#define EQ_WINDOW_HWND      0x00000000 // DWORD
#define EQ_WINDOW_WIDTH     0x00000000 // DWORD
#define EQ_WINDOW_HEIGHT    0x00000000 // DWORD

#define EQ_BOOL_AUTO_ATTACK         0x00000000 // BYTE
#define EQ_BOOL_AUTO_FIRE           0x00000000 // BYTE
#define EQ_BOOL_AUTO_RUN            0x00000000 // DWORD
#define EQ_BOOL_NET_STATUS          0x00000000 // BYTE
#define EQ_BOOL_SAFELOCK            0x00000000 // BYTE
#define EQ_BOOL_SCREENSHOT          0x00000000 // BYTE ; set to 1 to force the game to take a screenshot
#define EQ_BOOL_INVITED_TO_GROUP    0x00000000 // BYTE
...
#define EQ_POINTER_0x00B112C0                 0x00B112C0 // zone actor info found in here

#define EQ_POINTER_StringTable                0x00A4259C // pinstStringTable
DWORD EQ_POINTER_CDisplay = 0x9D2660;
...
DWORD EQ_POINTER_SPAWN_INFO_FIRST  = 0xA641D0; // pinstSpawnManager
DWORD EQ_POINTER_SPAWN_INFO_PLAYER = 0xD92644; // pinstCharSpawn
DWORD EQ_POINTER_SPAWN_INFO_TARGET = 0xD92648; // pinstTarget
...
DWORD EQ_FUNCTION_DrawNetStatus = 0x173620;
...
DWORD EQ_FUNCTION_CDisplay__WriteTextHD2 = 0x8EB40;
